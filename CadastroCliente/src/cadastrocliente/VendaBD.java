...
public class VendaBD {
    ...
    public void adicionarVenda(Venda v){
        String insert = "insert into vendapdv.venda(codigo, data, cliente, cod_produto, qtd_produto, total_produto, total, pagamento) values(?,?,?,?,?,?,?,?)";
    ...
    public ArrayList<Venda>lerBancoVenda(){
        try {
            ...
            String select = "select * from vendapdv.venda";
    ...
    public ArrayList<Venda> lerBancoVendaDistintos(){
        try {
            ArrayList<Venda> lista = new ArrayList<>();
            String select = "select distinct codigo, cliente, total from vendapdv.venda";
            PreparedStatement stmt = conexao.prepareStatement(select);
            ResultSet rs = stmt.executeQuery();
            while(rs.next()){
                Venda obj = new Venda();
    ...
    public ArrayList<Venda> buscarVenda(String codigo){
        try {
            ArrayList<Venda> lista = new ArrayList<>();
            String select = "select * from vendapdv.venda where codigo=" + codigo;
            PreparedStatement stmt = conexao.prepareStatement(select);
            ResultSet rs = stmt.executeQuery();
            while(rs.next()){
                Venda obj = new Venda();
